...
#Cписок доступных тарифных планов
...
class UserSubscriptionView(generics.RetrieveAPIView):
    ...
    # Возвращаем подписку пользователя или None
    def get_object(self):
        try:
...
#API для просмотра истории изменений подписки пользователя
class SubscriptionHistoryView(generics.ListAPIView):
    serializer_class = SubscriptionHistorySerializer
    permission_classes = [permissions.IsAuthenticated]

    #Возвращаем историю подписки пользователя
...
# API для просмотра статуса подписки пользователя
@api_view(['GET'])
@permission_classes([permissions.IsAuthenticated])
...
#API для закрепления поста пользователя
@api_view(['POST'])
@permission_classes([permissions.IsAuthenticated])
...
# API для открепления поста пользователя
@api_view(['POST'])
@permission_classes([permissions.IsAuthenticated])
...
# API для отмены подписки пользователя
@api_view(['POST'])
@permission_classes([permissions.IsAuthenticated])
...
# API для получения списка всех закрепленных постов для отображения в топе
@api_view(['GET'])
@permission_classes([permissions.AllowAny])
...
# API для проверки публикации на возможность закрепления
@api_view(['GET'])
@permission_classes([permissions.IsAuthenticated])
