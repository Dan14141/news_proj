...
from apps.sub.models import Subscription, SubscriptionPlan, SubscriptionHistory
...
class StripeService:
    ...
    # Возвращаем платеж через Stripe
    @staticmethod
