...
# API для просмоотра списка платежей пользователя
class PaymentListView(generics.ListAPIView):
    serializer_class = PaymentSerializer
    permission_classes = [permissions.IsAuthenticated]

    # Возвращаем платежи текущего пользователя
...
#API для просмотра списка возвратов для администраторов
...
# API дял создания возврата платежа
@api_view(['POST'])
@permission_classes([permissions.IsAdminUser])
...
# API для просмотра аналитики по платежам для администраторов
@api_view(['GET'])
@permission_classes([permissions.IsAdminUser])
...
# API для просмотра истории платежей пользователя
@api_view(['GET'])
@permission_classes([permissions.IsAuthenticated])
